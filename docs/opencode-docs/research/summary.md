...
> **Дата:** 2026-05-13
> **Версия:** 1.2
> **Источник:** ai-agent-mechanisms-review.md (исходный документ обзора, не включён в этот репозиторий)
...
Рекомендации в этом документе классифицированы по силе доказательства (см. [методологию](literature-review-methodology.md)):
...
Дополнительное исследование: dynamic-agent-templates.md (не включён в этот репозиторий)
...
Детальный план: [local-eval-plan.md](local-eval-plan.md)
